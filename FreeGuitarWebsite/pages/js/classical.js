...
var whatisTitle=["text","heading","Classical Guitar:"];
//html tag references to be inserted in gui.
var whatis=["text","paragraph","It's for squares, its strings are made of plastic."];
...
var photo=["img","c40.jpg","I have one of these"];
